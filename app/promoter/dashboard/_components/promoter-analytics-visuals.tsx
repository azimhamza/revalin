...
export function PromoterAnalyticsVisuals({
  trend,
  referrers,
  landingPaths,
  devices,
  ...
  return (
    <section className="space-y-3">
      <div className="grid gap-3 xl:grid-cols-[1.45fr_0.9fr]">
        <Card className={chartCardClass}>
          <CardHeader className="border-b border-[#0B2E2F]/10 px-3.5 py-3">
            ...
            <CardDescription className="text-[12px] leading-5 text-[#0B2E2F]/58">
              Aggregate daily activity across your recruited Growth Partners over the last 30 days.
            </CardDescription>
          </CardHeader>
          <CardContent className="p-0">
            {trend.length > 0 ? (
        ...
        <Card className={chartCardClass}>
          <CardHeader className="border-b border-[#0B2E2F]/10 px-3.5 py-3">
            ...
            <CardDescription className="text-[12px] leading-5 text-[#0B2E2F]/58">
              Daily purchase rate from attributed visits across all recruited partners.
            </CardDescription>
          </CardHeader>
          <CardContent className="p-0">
      ...
      <div className="grid gap-3 xl:grid-cols-3 2xl:grid-cols-4">
        <BreakdownChart
          title="Referrers"
          description="Hosts sending traffic to your recruited Growth Partners."
          items={referrers}
          metricLabel="Visits"
          barColor="#0B2E2F"
          labelWidth={112}
        ...
        <BreakdownChart
          title="Landing paths"
          description="Destination paths hit through your recruited partners' links."
          items={landingPaths}
          metricLabel="Visits"
          barColor="#58706B"
          labelWidth={120}
        ...
        <BreakdownChart
          title="UTM source"
          description="Campaign source values captured on partner traffic."
          items={utmSources}
          metricLabel="Visits"
          barColor="#315B5D"
          labelWidth={114}
        ...
        <BreakdownChart
          title="UTM medium"
          description="Campaign medium values captured on partner traffic."
          items={utmMediums}
          metricLabel="Visits"
          barColor="#96713A"
          labelWidth={114}
        ...
        <BreakdownChart
          title="UTM campaign"
          description="Campaign names carried by tracked partner traffic."
          items={utmCampaigns}
          metricLabel="Visits"
          barColor="#0F3638"
          labelWidth={122}
