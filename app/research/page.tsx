...
export const metadata: Metadata = {
  title: 'Research Library - Compound Profiles & Documentation',
  description:
    'Comprehensive research chemical profiles with handling specifications, technical documentation, and peer-reviewed study references.',
  alternates: {
    canonical: '/research',
  },
};
          ...
          <div className="col-span-9 flex flex-col md:h-full md:pt-top-spacing">
            <header className="space-y-4 px-sides pt-10 text-[#0B2E2F] md:px-0 md:pt-0 md:pr-sides">
              ...
              <h1 className="max-w-3xl text-balance text-3xl tracking-[-0.05em] md:text-[3.1rem] md:leading-[0.95]">
                Compounds, documentation, and published papers.
              </h1>
              <p className="max-w-xl text-sm leading-relaxed text-[#0B2E2F]/72 md:text-base">
                A curated library of research chemical profiles and peer-reviewed
