...
export const AFFILIATE_LANDING_CODE_PARAM = "__revalin_aff";
export const AFFILIATE_LANDING_DISCOUNT_PARAM = "__revalin_aff_discount";
export const AFFILIATE_LANDING_PATH_PARAM = "__revalin_aff_path";
export const AFFILIATE_LANDING_REFERRER_PARAM = "__revalin_aff_ref";
